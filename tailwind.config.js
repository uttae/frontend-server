  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        "heading-s": ["24px", { lineHeight: "34px", fontWeight: "700", letterSpacing: "-0.02em" }],
        "title-l": ["22px", { lineHeight: "30px", fontWeight: "700", letterSpacing: "-0.02em" }],
        "title-m": ["20px", { lineHeight: "28px", fontWeight: "700", letterSpacing: "-0.02em" }],
        "title-s": ["18px", { lineHeight: "26px", fontWeight: "700", letterSpacing: "-0.02em" }],
        "body-l-regular": ["18px", { lineHeight: "28px", fontWeight: "400", letterSpacing: "-0.02em" }],
        "body-l-emphasis": ["18px", { lineHeight: "28px", fontWeight: "600", letterSpacing: "-0.02em" }],
        "body-m-regular": ["16px", { lineHeight: "24px", fontWeight: "400", letterSpacing: "-0.02em" }],
        "body-m-emphasis": ["16px", { lineHeight: "24px", fontWeight: "600", letterSpacing: "-0.02em" }],
        "body-s-regular": ["14px", { lineHeight: "20px", fontWeight: "400", letterSpacing: "-0.02em" }],
        "body-s-emphasis": ["14px", { lineHeight: "20px", fontWeight: "600", letterSpacing: "-0.02em" }],
        "body-xs-regular": ["12px", { lineHeight: "16px", fontWeight: "400", letterSpacing: "-0.02em" }],
        "body-xs-emphasis": ["12px", { lineHeight: "16px", fontWeight: "600", letterSpacing: "-0.02em" }],
        ...
        "label-s-regular": ["13px", { lineHeight: "18px", fontWeight: "500", letterSpacing: "-0.02em" }],
        "label-s-emphasis": ["13px", { lineHeight: "18px", fontWeight: "700", letterSpacing: "-0.02em" }],
        "label-xs-regular": ["12px", { lineHeight: "16px", fontWeight: "500", letterSpacing: "-0.02em" }],
        "label-xs-emphasis": ["12px", { lineHeight: "16px", fontWeight: "700", letterSpacing: "-0.02em" }],
        "caption-l-regular": ["13px", { lineHeight: "18px", fontWeight: "400", letterSpacing: "-0.02em" }],
        "caption-l-emphasis": ["13px", { lineHeight: "18px", fontWeight: "600", letterSpacing: "-0.02em" }],
        "caption-m-regular": ["12px", { lineHeight: "16px", fontWeight: "400", letterSpacing: "-0.02em" }],
        "caption-m-emphasis": ["12px", { lineHeight: "16px", fontWeight: "600", letterSpacing: "-0.02em" }],
        "caption-s-regular": ["11px", { lineHeight: "16px", fontWeight: "400", letterSpacing: "-0.02em" }],
        "caption-s-emphasis": ["11px", { lineHeight: "16px", fontWeight: "600", letterSpacing: "-0.02em" }],
      },
