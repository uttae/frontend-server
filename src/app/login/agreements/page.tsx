      ...
      <div className="relative w-full max-w-[600px] rounded-3xl border border-gray-border bg-white/95 p-8 shadow-[0_24px_80px_-12px_rgba(15,23,42,0.12)] backdrop-blur-sm">
        ...
        <div className="flex flex-col items-center gap-6 text-center">
          <div className="flex flex-col items-center gap-3">
            ...
            <div>
              <h1 className="text-heading-s mobile:text-title-l font-bold text-neutral-900">
                {isSignup ? "서비스 약관 동의" : "변경된 약관 재동의"}
              </h1>
              <p className="mt-2 text-body-m-regular mobile:text-body-s-regular leading-relaxed text-dark-gray">
                {isSignup
            ...
            >
              ...
              {isExpired && (
                <button
                  type="button"
                  onClick={returnToLogin}
                  className="mt-3 text-label-l-emphasis mobile:text-label-m-emphasis font-semibold text-primary underline-offset-2 hover:underline"
                >
                  Google 로그인 다시 시작하기
                </button>
              )}
          ...
          <button
            ...
            className="flex w-full items-center justify-center rounded-xl bg-primary px-4 py-3 text-label-xl-emphasis mobile:text-label-l-emphasis font-semibold text-white shadow-sm transition hover:bg-primary/90 disabled:cursor-not-allowed disabled:opacity-50"
          >
            {isSubmitting
              ? "처리 중…"
              : isSignup
