  ...
  return (
    <LoginShell>
      ...
      <button
        ...
        className="flex w-full items-center justify-center gap-3 rounded-xl border border-gray-border bg-white px-4 py-3 text-label-xl-regular font-medium text-[#1f1f1f] shadow-sm transition hover:bg-bubble-gray/60 hover:shadow disabled:cursor-not-allowed disabled:opacity-50"
      >
  ...
  return (
    <LoginShell>
      <button
        ...
        disabled
        aria-disabled="true"
        className="flex w-full cursor-wait items-center justify-center gap-3 rounded-xl border border-gray-border bg-white px-4 py-3 text-label-xl-regular font-medium text-[#1f1f1f] opacity-70 shadow-sm"
      >
        <GoogleMark className="h-5 w-5 shrink-0" />
        <span>Google로 계속하기</span>
      </button>
