...
export function RoomGrid({
  ...
  if (rooms.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center gap-10 rounded-[12px] bg-fill px-5 py-20 text-center mobile:min-h-[410px] mobile:justify-start mobile:rounded-none mobile:bg-transparent mobile:px-0 mobile:pb-0 mobile:pt-[60px]">
        <div className="flex flex-col items-center gap-5 mobile:gap-3">
          <div aria-hidden className="flex size-10 items-center justify-center [&_img]:size-10 mobile:size-[30px] mobile:[&_img]:size-[30px]">
