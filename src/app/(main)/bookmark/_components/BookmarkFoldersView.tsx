  ...
  if (isPending) {
    return (
      <div className="space-y-2.5">
        ...
        <div className="py-10 text-center text-body-m-regular text-dark-gray">
          불러오는 중…
        </div>
      </div>
    );
    ...
    <div className="space-y-2.5 pb-8">
      ...
      <div className="rounded-2xl border border-gray-border bg-white">
        {folders.length === 0 ? (
          <p
            className={cn(
              "py-10 text-center text-body-m-regular text-dark-gray",
                    ...
                    {menuOpenId === folder.id && (
                      ...
                      >
                        <button
                          type="button"
                          role="menuitem"
                          className="block w-full cursor-pointer px-4 py-2 text-left text-label-l-regular text-neutral-900 hover:bg-bubble-gray disabled:cursor-not-allowed disabled:opacity-50"
                          disabled={
                        ...
                        <button
                          type="button"
                          role="menuitem"
                          className="block w-full cursor-pointer px-4 py-2 text-left text-label-l-regular text-status-negative hover:bg-red-50 disabled:cursor-not-allowed disabled:opacity-50"
                          disabled={
                            isRowDeleting(folder.id) || isRowUpdating(folder.id)
                          }
