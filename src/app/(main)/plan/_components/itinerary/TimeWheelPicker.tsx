        ...
        {items.map((v, i) => {
          ...
          return (
            <button
              ...
              onClick={() => commit(i)}
              className={cn(
                "flex w-full snap-center items-center justify-center text-title-m font-semibold tabular-nums transition-colors",
  ...
  return (
    <div className="relative isolate flex items-center justify-center gap-2">
      ...
      <div className="relative z-10 flex items-center gap-2">
        ...
        <span
          aria-hidden
          className="pt-[2px] text-title-m font-semibold text-gray-400"
        >
          :
        </span>
        <WheelColumn
