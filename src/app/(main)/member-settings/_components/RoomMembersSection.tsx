...
export function RoomMembersSection() {
  ...
  return (
    <div className="relative flex flex-col gap-6">
      ...
      {!isMembersLoading && me && (
        <section>
          <p className="mb-1.5 text-body-s-emphasis font-semibold uppercase tracking-wide text-dark-gray">
            나
          </p>
            ...
            {others.map((member, i) => (
              <div key={member.userId}>
                ...
                {transferTargetId === member.userId && (
                  ...
                  >
                    <p className="mb-2 text-body-s-emphasis font-medium text-gray-800">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="flex-1 cursor-pointer rounded-lg border border-gray-border py-1.5 text-label-m-regular font-medium text-dark-gray transition-colors hover:border-gray-400 disabled:cursor-not-allowed disabled:opacity-40"
                      >
                        취소
                      </button>
                      <button
                        ...
                        disabled={isTransferring}
                        className="flex-1 cursor-pointer rounded-lg bg-primary py-1.5 text-label-m-regular font-medium text-white transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-40"
                      >
      ...
      <div className="flex flex-col gap-2 border-t border-gray-border pt-4">
        {!showLeaveConfirm ? (
          ...
          <div className="rounded-xl border border-primary/30 bg-primary/5 p-4">
            <p className="mb-3 text-body-m-emphasis font-medium text-gray-800">
              정말 방에서 나가시겠어요?
            </p>
            <p className="mb-4 text-body-s-regular leading-5 text-dark-gray">
