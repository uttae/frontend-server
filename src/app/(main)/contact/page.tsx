...
import { BUG_REPORT_FORM_URL, FEEDBACK_FORM_URL } from "@/lib/contact";
    ...
    <MainSettingsPageLayout>
      <div className="flex min-w-0 w-full flex-col gap-4">
        ...
        <Link
          ...
          className="inline-flex w-fit items-center gap-1.5 text-label-l-regular mobile:text-label-m-regular font-medium text-primary transition hover:opacity-80"
        >
          피드백 설문 보내기
