    ...
    <div className="relative flex min-h-screen flex-col items-center justify-center gap-10 overflow-hidden bg-gradient-to-b from-bubble-gray/60 via-white to-white px-4 py-12">
      ...
      <div className="relative w-full max-w-sm rounded-3xl border border-gray-border bg-white/95 p-8 shadow-[0_24px_80px_-12px_rgba(15,23,42,0.10)] backdrop-blur-sm">
        ...
        <div className="mb-6 text-center">
          {isRejected ? (
            <>
              <h1 className="mb-2 text-title-l font-semibold text-gray-800">
                입장이 거절되었습니다
              </h1>
        ...
        {/* 오류 */}
        {fetchError && (
          <p className="mb-4 rounded-xl bg-status-negative/10 px-4 py-2.5 text-center text-body-s-regular text-status-negative">
        ...
        {!isRejected && (
          <button
            ...
            disabled={isChecking}
            className="flex w-full items-center justify-center gap-2 rounded-xl border border-gray-border py-2.5 text-label-l-regular font-medium text-dark-gray transition-colors hover:border-gray-400 hover:text-black disabled:opacity-50"
          >
        ...
        {isRejected && (
          <button
            ...
            className="w-full rounded-xl border border-gray-border py-2.5 text-label-l-regular font-medium text-dark-gray transition-colors hover:border-gray-400 hover:text-black"
          >
            홈으로 돌아가기
          </button>
        )}
      ...
      {!isRejected && (
        <p className="relative text-body-s-regular text-light-gray">
