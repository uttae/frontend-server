  ...
  if (isPending) {
    return (
      <div className="w-full rounded-xl border border-gray-border bg-bubble-gray/40 px-4 py-3 text-left">
        <p className="text-body-m-regular text-dark-gray">약관을 불러오는 중…</p>
      </div>
    );
  }
  ...
  if (isError) {
    return (
      <div className="w-full rounded-xl border border-primary/35 bg-primary/[0.06] px-4 py-3 text-left">
        ...
        <p className="mt-1 text-body-m-regular text-muted-brown">
        ...
        <button
          ...
          className="mt-2 text-label-l-regular font-medium text-primary underline-offset-2 hover:underline"
        >
          다시 시도
        </button>
      </div>
  ...
  return (
    <div className="w-full rounded-xl border border-gray-border bg-bubble-gray/25 px-4 py-4 text-left">
      <label className="flex cursor-pointer items-start gap-3">
        ...
        />
        <span className="text-body-m-emphasis font-semibold leading-snug text-neutral-900">
          필수 약관 전체 동의
        </span>
      </label>
          ...
          return (
            ...
            >
              <label className="flex min-w-0 flex-1 cursor-pointer items-center gap-2">
                ...
                <span className="truncate text-body-m-regular text-neutral-800">
                  {item.title}
                </span>
              </label>
              <Link
                ...
                className="group flex shrink-0 items-center gap-0.5 text-label-m-regular font-medium text-dark-gray hover:text-neutral-900"
              >
                자세히 보기
