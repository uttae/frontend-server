...
export function ExpenseBudgetSummary() {
  ...
  return (
    <div className="space-y-4">
      <div className="space-y-2 text-body-s-regular">
        <h3 className="text-body-s-emphasis font-medium text-dark-gray">여행 전체 지출</h3>
        ...
        <p className="break-all text-heading-s font-bold tracking-tight tabular-nums">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 rounded-xl bg-white p-3">
        <div className="min-w-0 max-w-full">
          <h3 className="text-body-s-emphasis font-medium text-dark-gray">여행 전체 예산</h3>
          ...
          {budget.isSuccess && (
            <p className="break-all text-title-m font-bold tabular-nums">
              {amount === null
                ? "미설정"
