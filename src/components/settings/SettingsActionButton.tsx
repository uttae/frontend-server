...
export const settingsActionButtonVariantClass = {
  secondary:
    "rounded-full border border-gray-border bg-transparent py-2.5 text-label-l-emphasis font-semibold text-dark-gray transition hover:bg-bubble-gray disabled:cursor-not-allowed disabled:opacity-40",
  primary:
    "rounded-full border border-transparent bg-primary py-2.5 text-label-l-emphasis font-semibold text-white transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-40",
} as const;
