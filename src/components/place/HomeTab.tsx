...
export function HomeTab({
  ...
  return (
    <div className="border-b border-gray-border px-5 py-4">
      <h3 className="mb-2.5 text-body-xs-emphasis font-semibold text-[#364153]">
        기본 정보
      </h3>
        ...
        {(address || googleMapsUrl) && (
          <li className="flex items-start gap-3">
            ...
            <div className="min-w-0 flex-1">
              {address && (
                <span className="block text-body-xs-regular leading-relaxed text-[#364153]">
                  {address}
                </span>
              )}
              {googleMapsUrl && (
        ...
        {hours && (
          <li className="flex items-start gap-3">
            ...
            <div className="flex-1">
              {isOpen != null && (
                <span
                  className={`text-body-xs-emphasis font-medium ${
              ...
              <p className="mt-0.5 whitespace-pre-line text-body-xs-regular leading-relaxed text-dark-gray">
                {hours}
              </p>
            </div>
          </li>
      ...
      {reviewSummary && (
        <div className="mt-4 rounded-xl bg-gray-50 px-3 py-3">
          <p className="mb-1 text-body-xs-emphasis font-semibold uppercase tracking-wide text-dark-gray">
            AI 리뷰 요약
          </p>
          <p className="text-body-xs-regular leading-relaxed text-[#364153]">
            {reviewSummary}
          </p>
        </div>
      )}
