    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="mt-1 flex flex-wrap items-center gap-x-1.5">
          ...
          <span className="text-body-xs-emphasis font-medium leading-relaxed text-[#364153]">
            {rating != null ? rating.toFixed(1) : "-"}
          </span>
          {userRatingCount != null && (
            <span className="text-body-xs-regular leading-relaxed text-[#99A1AF]">
              ({userRatingCount.toLocaleString()})
            </span>
          )}
          {isOpen !== undefined && (
            <span
              className={`text-body-xs-emphasis font-medium leading-relaxed ${
