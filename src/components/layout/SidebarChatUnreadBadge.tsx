...
export function SidebarChatUnreadBadge() {
  ...
  return (
    <span className="pointer-events-none absolute left-1/2 top-2.5 flex h-4 min-w-4 items-center justify-center rounded-full border border-background bg-primary px-0.5 text-caption-s-emphasis font-semibold leading-none tracking-[-0.02em] text-text-inverse">
      {label}
    </span>
  );
}
