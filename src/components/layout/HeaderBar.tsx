            ...
            {currentRoom || displayTitle ? (
              <>
                <div className="flex min-w-0 items-center gap-1">
                  <span className="block truncate text-body-m-emphasis mobile:text-body-s-emphasis font-semibold leading-tight">
                ...
                <span className="block truncate text-body-s-regular mobile:text-body-xs-regular leading-tight text-dark-gray">
                  {dateStr}
                </span>
              </>
            ) : isPending ? (
              <span
                className="block text-body-m-emphasis mobile:text-body-s-emphasis font-semibold leading-tight text-dark-gray"
                aria-busy="true"
              >
                …
              </span>
            ) : (
              <span className="block truncate text-body-m-emphasis mobile:text-body-s-emphasis font-semibold leading-tight text-dark-gray">
                방 정보 없음
              </span>
            )}
          </div>
