  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-screen-xl items-center gap-2 px-4 py-2.5 text-primary">
        ...
        <p className="min-w-0 flex-1 text-body-s-emphasis font-medium leading-snug sm:text-body-m-emphasis">
          {connectionIssue}
        </p>
        <button
          type="button"
          ...
          className={cn(
            ...
            "text-label-m-emphasis font-semibold text-primary transition-colors",
